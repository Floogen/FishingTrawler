        ...
        internal static void CheckActionPatch(IslandSouthEast __instance, ref bool __result, xTile.Dimensions.Location tileLocation, xTile.Dimensions.Rectangle viewport, Farmer who)
        {
            ...
            switch (tile.Properties["CustomAction"].ToString())
            {
                ...
                case "TrawlerNote":
                    ...
                    {
                        Game1.drawObjectDialogue(string.Format("There's a note here...#It is from Murphy! It says he will be docked every {0} and to speak with him before nightfall if you wish to go on a fishing trip.", Game1.MasterPlayer.modData[FishingTrawler.MURPHY_DAY_TO_APPEAR_ISLAND]));
                        break;
                    }
